...
class AngieAdvancedTemp:
    ...
    def create_gui(self):
        self.root = ctk.CTk()
        self.root.title("Angie Advanced - Asistente Virtual Pro (Sin Gemini)")
        ...
        # Aviso sobre Gemini
        warning_label = ctk.CTkLabel(main_frame, text="⚠️ Modo sin IA: Las respuestas generales no están disponibles", 
        ...
        self.info_label = ctk.CTkLabel(info_frame, text="Listo para ayudarte (sin IA)", 
    ...
    def process_command(self, command):
        ...
        # Comandos de cierre
            ...
            # Respuesta sin IA
            respuesta = "Lo siento, no entiendo ese comando. Prueba con: reproducir música, hora, clima, noticias, buscar, notas, captura, sistema, recordatorios, tareas, o abre un sitio web."
    ...
    def get_weather(self):
        try:
            ...
            if response.status_code == 200:
                ...
                weather_info = f"En {city}: {temp}°C, {description}, humedad: {humidity}%"
